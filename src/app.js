...
import { SpriteTest, SpriteTimeTest } from './utils'

export default class App extends Component {
  render() {
    const MAIN = <SpriteTimeTest />
    if (MAIN) return MAIN
      ...
      <BrowserRouter>
        <div>
          <ul>
            ...
            <li><Link to="/spriteTimeTest">测试工具：测试雪碧图生成时间</Link></li>
          </ul>
          ...
          <Route exact path="/spriteTimeTest" component={SpriteTimeTest} />
        </div>
      </BrowserRouter>
    )
  }
